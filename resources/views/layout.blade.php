...
<head>
    ...
    <title>Cửa hàng thời trang nam BP</title>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-user"></i>BP store</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> minhquang2912@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container">
                <div class="row">
                    <div class = "col-sm-12">
                        <p> </p>
                        <p> BP store</p>
                        <p>Địa chỉ : Ninh Sở - Thường Tín - Hà Nội</p>
                        <p>Email: minhquang2912@gmail.com Điện thoại: 0393352451</p>
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v6.0&appId=2339123679735877&autoLogAppEvents=1"></script>
  ...
  <script type="text/javascript">
    ...
    $('#imageGallery').lightSlider({
        gallery:true, // mã code này nhiều hình ảnh thì để là true
        item:1, //khi click vào thì chạy 1 item
        loop:true, // vòng lặp khi click vào click lại các hình ảnh
        thumbItem:3, // 3 hình ảnh gợi ý (hình ảnh nhỏ ở dưới)
        slideMargin:0,
        enableDrag: false,

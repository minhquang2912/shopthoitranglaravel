...
Route::get('delete-user-route/{admin_id}','UserController@delete_user_roles')->middleware('auth.roles');
...
Route::get('/send-mail-checkout','CheckoutController@sendmail_checkout');
//Order
